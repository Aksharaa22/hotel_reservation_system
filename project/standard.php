...
include_once('connection.php');
    ...
    if(isset($_POST['add_to_cart']))
    {
        ...
        VALUES ('".$_POST["members"]."','".$_POST["rooms"]."','".$_POST["days"]."','".$_POST["hidden_amt"]."','standard')";
...
<div id="myCarousel" class="carousel slide" data-ride="carousel">
    ...
    <div class="carousel-inner" role="listbox">
      <div class="item active">
        <img src="standardpic2.jpg" alt="New York" width="1200" height="700">
        <div class="carousel-caption">
          <h3>Standard </h3>
          <p>Our legendary suites are unique in design and comfort.</p>
        </div>      
      </div>

      <div class="item">
        <img src="standardpic1.jpg" alt="Chicago" width="1200" height="700">
        <div class="carousel-caption">
          <h3>King size beds </h3>
          <p>and other moderm amenities.</p>
        </div>      
      </div>
    
      <div class="item">
        <img src="standardpic3.jpg" alt="Los Angeles" width="1200" height="700">
        <div class="carousel-caption">
         ...
         <label>DAYS</label>
          <input type="text" id="days" name="days">
           Rupees: <?php echo $row["amt"]; ?>
            ...
            <td><a href="cart.php"><input  type="submit" name="add_to_cart"  class="btn" value="BOOK"  /></a></td>
...
<div id="band" class="container text-center">
  ...
  <p><em>Area: 470 to 1400 Sq. Ft (Based on standard type)</em></p>
  <p>Our legendary suites are unique in design and deliver unrivalled grandeur, splendour, and comfort. All suite rooms come with King size beds and other modern amenities.</p>
  <br>
